                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                       <a href="#">
                                        ...
                                        <a href="{{ url('gestionachat/ajouterCommandefournisseur/enregistrer') }}">
                                            <span class="badge bg-success"><i class="bi bi-pencil-square"></i></span>
                                        </a>
                                        <a href="{{ url('delete_commandeF/') }}" onclick="return confirm('Etes-vous sûr de la supprimer?')"><span class="badge bg-danger"><i class="bi bi-trash"></i></span></a>
                                    </td>
                                </tr>
                        </tbody>
                    </table>
